CREATE SCHEMA IF NOT EXISTS `RestoConcept` DEFAULT CHARACTER SET utf8 ;
USE `RestoConcept` ;

CREATE USER 'admin'@'localhost' IDENTIFIED BY 'admin';
GRANT ALL PRIVILEGES ON RestoConcept . * TO 'admin'@'localhost';
...
create table Accounts (
    ...
    alter table Orders
        add constraint CA_sxhpvsj665kmi4f7jdu9d2791  unique (Order_Num);
